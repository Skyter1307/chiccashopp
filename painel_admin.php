    ...
    <div class="row mt-4">
        <div class="col-md-4">
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="card-body">
                    <h5 class="card-title">Vendas diretas</h5>
                    <p class="card-text">Cadastrar, editar ou acompanhar vendas.</p>
                    <a href="cadastro_venda_direta.php" class="btn btn-light">Acessar</a>
                </div>
            </div>
        </div>
